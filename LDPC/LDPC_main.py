...
[1/3, 6, 53, 'AWGN', 0.95, 0.4, False], [1/3, 5, 53, 'AWGN', 0.95, 0.4, False],[1/3, 4, 53, 'AWGN', 0.95, 0.4, False],
[1/3, 3, 53, 'AWGN', 0.95, 0.4, False], [1/3, 2, 53, 'AWGN', 0.95, 0.4, False],

[1/2, 6, 53, 'AWGN', 0.95, 0.4, True], [1/2, 5, 53, 'AWGN', 0.95, 0.4, True],[1/2, 4, 53, 'AWGN', 0.95, 0.4, False],
[1/2, 3, 53, 'AWGN', 0.95, 0.4, True], [1/2, 2, 53, 'AWGN', 0.95, 0.4, True],
[1/3, 6, 53, 'AWGN', 0.95, 0.4, True], [1/3, 5, 53, 'AWGN', 0.95, 0.4, True],[1/3, 4, 53, 'AWGN', 0.95, 0.4, True],
[1/3, 3, 53, 'AWGN', 0.95, 0.4, True], [1/3, 2, 53, 'AWGN', 0.95, 0.4, True],


[1/2, 0.02, 53, 'BSC', 0.94, 0.4, False],[1/2, 0.04, 53, 'BSC', 0.94, 0.4, False],[1/2, 0.06, 53, 'BSC', 0.94, 0.4, False],
[1/2, 0.08, 53, 'BSC', 0.94, 0.4, False],[1/2, 0.1, 53, 'BSC', 0.94, 0.4, False],
[1/3, 0.02, 53, 'BSC', 0.94, 0.4, False],[1/3, 0.04, 53, 'BSC', 0.94, 0.4, False],[1/3, 0.06, 53, 'BSC', 0.94, 0.4, False],
[1/3, 0.08, 53, 'BSC', 0.94, 0.4, False],[1/3, 0.1, 53, 'BSC', 0.94, 0.4, False],

[1/2, 0.02, 53, 'BSC', 0.94, 0.4, True],[1/2, 0.04, 53, 'BSC', 0.94, 0.4, True],[1/2, 0.06, 53, 'BSC', 0.94, 0.4, True],
[1/2, 0.08, 53, 'BSC', 0.94, 0.4, True],[1/2, 0.1, 53, 'BSC', 0.94, 0.4, True],
[1/3, 0.02, 53, 'BSC', 0.94, 0.4, True],[1/3, 0.04, 53, 'BSC', 0.94, 0.4, True],[1/3, 0.06, 53, 'BSC', 0.94, 0.4, True],
[1/3, 0.08, 53, 'BSC', 0.94, 0.4, True],[1/3, 0.1, 53, 'BSC', 0.94, 0.4, True],
]
...
for elem in runs_vals:
    ...
    for iterations in range(runs):
        ...
        if channel == 'BEC':
            import minsum_BEC
            aa, suces, iter = minsum_BEC.minsum_BEC(H=HRM, r=llr_r, Zc=Zc, K=K)
            #print(suces, iter)
        else:
            import LDPC_MinSum
