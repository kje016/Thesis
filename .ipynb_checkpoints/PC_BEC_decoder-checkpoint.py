...
#Useful (maybe) sage shell commands:
...
# no need to create function for 'V'
def f(alpha1, alpha2):
    return [xor(a, b) for a in alpha1 for b in alpha2]


def g(alpha1, alpha2, beta):
    alpha2 & (xor(alpha1, beta))
